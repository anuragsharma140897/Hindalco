...
export default function SearchableSelect({ type, label, important, api, name, error, disabled, getFieldName, onChange, limit, dynamicSearch, defaultValueIndex, className, hide }) {
        ...
        !hide && <div className='mb-2'>
          ...
          {options ? <Select
            ...
            defaultValue={options[
              typeof defaultValueIndex === 'number' && defaultValueIndex >= 0 && defaultValueIndex < options?.length
                ? defaultValueIndex
                : 0
            ]}
            onChange={onChange}
