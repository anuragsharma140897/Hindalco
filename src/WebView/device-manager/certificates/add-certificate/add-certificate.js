 ...
 <div>
     <div className='mt-10 bg-white p-10'>
      <div className='grid grid-cols-4 gap-4'>
        ...
        <SearchableSelect name="certificateType" label="Certificate Type" api={searchGeneral} checkServerKey={'fieldName'} checkServerValue={'certificateType'} getFieldName={'value'} dynamicSearch={{ fieldName: 'certificateType' }} value={reduxCertificates?.apiJson?.roleName} reduxState={reduxCertificates?.apiJson} onChange={(e) => handleOnChange(e, 'certificateType')}/>
