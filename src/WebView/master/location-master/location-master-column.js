...
export const getLocationMasterColumns = ({ openModal, closeModal ,loading, setLoading}) => [
    ...
    render: (_, row) => (
      <div className="flex items-center gap-3 pe-4">
        ...
        />
          ...
          <Tooltip size="sm" content={'Add Zone'} placement="top" color="invert">
          <label>
            <ActionIcon as="span" size="sm" variant="outline" className="hover:text-gray-700" onClick={() => EditScreen(openModal, closeModal, row, 'Add Zone', AddLocationZone, 800)}>
