        ...
        <div>
            ...
            <div className='bg-white p-5 mb-5 rounded-xl'>
                <div className='grid grid-cols-3 gap-x-4'>
                    <CustomInput important={true} name="name" label="End point name" value={reduxConfiguration?.apiJson?.name} error={errors} reduxState={reduxConfiguration?.apiJson} setAction={setConfigurationMasterApiJson} />
                    <CustomInput important={true} name="description" label="End point Description" value={reduxConfiguration?.apiJson?.description} error={errors} reduxState={reduxConfiguration?.apiJson} setAction={setConfigurationMasterApiJson} />
                    <CustomSelect name="type" label="End point type" options={GenderOption} value={reduxConfiguration?.apiJson?.type} error={errors} reduxState={reduxConfiguration?.apiJson} setAction={setConfigurationMasterApiJson}  />
                </div>
            </div>
