            ...
            <div>
                <div>
                    ...
                    <div className='mt-5 grid grid-cols-3 gap-x-4'>
                        ...
                        <CustomInput important={true} name="managementEventsretain" label="Retain"  value={reduxConfiguration?.apiJson?.managementEventsretain} error={reduxConfiguration?.error} reduxState={reduxConfiguration?.apiJson} setAction={setConfigurationMasterApiJson}/>
                    </div>
                </div>
                <div>
                    ...
                    <div className='mt-5 grid grid-cols-3 gap-x-4'>
                        ...
                        <CustomInput important={true} name="tagEventsretain" label="Retain" value={reduxConfiguration?.apiJson?.tagEventsretain} error={reduxConfiguration?.error} reduxState={reduxConfiguration?.apiJson} setAction={setConfigurationMasterApiJson}  />
                    </div>
                </div>
                <div>
                    ...
                    <div className='p-2'>
                        <div>
                            ...
                            <div className='mt-5 grid grid-cols-3 gap-x-4'>
                                ...
                                <CustomInput important={true} name="managementcommandretain" label="Retain" value={reduxConfiguration?.apiJson?.managementcommandretain} error={reduxConfiguration?.error} reduxState={reduxConfiguration?.apiJson} setAction={setConfigurationMasterApiJson} />
                            </div>
                        </div>
                        <div>
                            ...
                            <div className='mt-5 grid grid-cols-3 gap-x-4'>
                                ...
                                <CustomInput important={true} name="managementresponseretain" label="Retain" value={reduxConfiguration?.apiJson?.managementresponseretain} error={reduxConfiguration?.error} reduxState={reduxConfiguration?.apiJson} setAction={setConfigurationMasterApiJson} />
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div className='p-2'>
                        <div>
                            ...
                            <div className='mt-5 grid grid-cols-3 gap-x-4'>
                                ...
                                <CustomInput important={true} name="controlcommandretain" label="Retain"  value={reduxConfiguration?.apiJson?.controlcommandretain} error={reduxConfiguration?.error} reduxState={reduxConfiguration?.apiJson} setAction={setConfigurationMasterApiJson} />
                            </div>
                        </div>
                        <div>
                            <div className='font-bold text-base underline'>Response</div>
                            <div className='mt-5 grid grid-cols-3 gap-x-4'>
                                ...
                                <CustomInput important={true} name="controlresponseretain" label="Retain"  value={reduxConfiguration?.apiJson?.controlresponseretain} error={reduxConfiguration?.error} reduxState={reduxConfiguration?.apiJson} setAction={setConfigurationMasterApiJson} />
                            </div>
                        </div>
                    </div>
                </div>
