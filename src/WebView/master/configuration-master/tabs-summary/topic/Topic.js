            ...
            <div>
                <div>
                    ...
                    <div className='mt-5 grid grid-cols-3 gap-x-4'>
                        <CustomInput important={true} name="managementEventsTopic" label="Topic" value={reduxConfiguration?.apiJson?.managementEventsTopic} error={errors} reduxState={reduxConfiguration?.apiJson} setAction={setConfigurationMasterApiJson} />
