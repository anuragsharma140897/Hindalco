...
export const getZoneMasterColumns = ({ openModal, closeModal }) => [
  ...
  },
  {
    ...
    render: (_, row) => (
      <div className="flex items-center gap-3 pe-4">
        ...
        <DeletePopover title={`Delete Zone Master`}  description={`Are you sure you want to delete this employee?`} 
...
export const DeleteItem = (id) =>{
  var json = {id:id}
  HitApi(json, deleteZone).then((Result)=>{
